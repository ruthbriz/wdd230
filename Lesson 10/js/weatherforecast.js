...
.then((jsObject) => {
  ...
  const daynames = ["Sunday", "Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
  const tuesday = daynames[jsObject.list[0].dt_txt];
  ...
  const daynames = ["Sunday", "Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
  const wednesday = daynames[jsObject.list[0].dt_txt];
  ...
  const daynames = ["Sunday", "Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
  const thursday = daynames[jsObject.list[0].dt_txt];
  ...
  const daynames = ["Sunday", "Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
  const friday = daynames[jsObject.list[0].dt_txt];
